<div class="notas form in-table">
    ...
    <?php echo $this->Form->create('Nota', array('controller' => 'notas', 'action' => 'add', 'admin' => 1, 'id' => 'NotaAddForm' . $type_id, 'class' => 'row')); ?>
    ...
    <div class="actions">
        <?php 
            echo $this->Form->end(array('label' => 'Agregar', 'class' => 'btn btn-success', 'div' => false));
            echo $this->Html->link('Cerrar', '#close', array('class' => 'btn'));
            echo $this->Html->link('Ver todas las notas.', array('controller' => 'notas', 'action' => 'index', $type, $type_id ));
        ?>
    </div>
</div>